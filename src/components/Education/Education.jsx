...
const Education = () => {
  return (
    <div
      id="education"
      className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20 font-sans bg-skills-gradient clip-path-custom-3"
    >
      {/* Section Title */}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
                {/* School Logo/Image */}
                <div className="w-16 h-12 sm:w-20 sm:h-14 md:w-24 md:h-16 bg-white rounded-md overflow-hidden flex-shrink-0">
                  <img
                    src={edu.img}
                    alt={edu.school}
              ...
              <p className="mt-2 sm:mt-4 text-sm sm:text-base text-gray-400 leading-relaxed">{edu.desc}</p>
            </div>
          </div>
        ))}
      </div>
